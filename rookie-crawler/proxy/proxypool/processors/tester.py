...
from proxy.proxypool.schemas import Proxy
from proxy.proxypool.storages.redis import RedisClient
from proxy.proxypool.setting import TEST_TIMEOUT, TEST_BATCH, TEST_URL, TEST_VALID_STATUS
